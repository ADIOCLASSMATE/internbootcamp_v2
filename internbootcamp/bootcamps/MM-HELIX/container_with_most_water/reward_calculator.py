...
class ContainerWithMostWaterRewardCalculator(BaseRewardCalculator):
    """
    盛最多水的容器问题的奖励计算器
    ...
    def _calculate_score(cls, extracted_output: Dict[str, Any], identity: Dict[str, Any]) -> float:
        ...
        # 8. 总分 = format_score + answer_score
