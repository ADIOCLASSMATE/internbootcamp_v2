...
bash internbootcamp/bootcamps/reasoning-gym/rectangle_count/scripts/rectangle_count_generator.sh
...
for MODEL in "${MODEL_LIST[@]}"; do
    ...
    bash internbootcamp/bootcamps/reasoning-gym/rectangle_count/scripts/eval.sh
